package com.daviddevelops.RPGCore.Utility;

import com.daviddevelops.RPGCore.Classes.ClassHandler;
import com.daviddevelops.RPGCore.Commands.CommandHandler;
import com.daviddevelops.RPGCore.Events.EventHandler;
import com.daviddevelops.RPGCore.Player.PlayerHandler;
import org.bukkit.plugin.Plugin;

public class Utility {

    Plugin plugin; ClassHandler classHandler; PlayerHandler playerHandler; CommandHandler commandHandler; EventHandler eventHandler;

    public Utility(Plugin plugin){
        this.plugin = plugin;
        this.classHandler = registerClassHandler(this);
...
//    --[ Class command registration  ]--
    ...
    private ClassHandler registerClassHandler(Utility utility) {
